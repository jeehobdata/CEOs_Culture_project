...
insert into ceo_culture_dwh_2.country 
	...
	select  e.country_ as country_,
			e.ceo_bio_id_ as ceo_id_,
			e.g_leadership_id_ as g_leadership_id_,
			e.g_societal_culture_id_ as g_societal_culture_id_,
			e.hofstede_id_ as hofstede_id_
			from (
