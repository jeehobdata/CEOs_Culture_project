...
insert into ceo_culture_dwh_2.country 
	...
	select  e.country_ as country,
			...
			from (
				...
				select distinct f.country_ as country_,  
								f.g_leadership_id_ as g_leadership_id_,
								f.g_societal_culture_id_ as g_societal_culture_id_,
								f.ceo_bio_id_ as ceo_bio_id_,
								f.hofstede_id_ as hofstede_id_,
                                f.year_ as year_
				from	
					( 
					select distinct gl15.country__ as country_,  
									gl15.g_leadership_id_ as g_leadership_id_,
									ceo_culture_stg.globe_societal_culture.Country as g_societal_culture_id_,
									ceo_culture_stg.ceo_bio_2015.id as ceo_bio_id_,
                                    ceo_culture_stg.ceo_bio_2015.`year` as year_,
									ceo_culture_stg.hofstede.hofstede_id as hofstede_id_
									
					from (
						select distinct `Country Name` as country__, `Country` as g_leadership_id_
						from ceo_culture_stg.globe_leadership ) gl15
					left join ceo_culture_stg.globe_societal_culture on gl15.country__ = ceo_culture_stg.globe_societal_culture.`Country Name`
					left join ceo_culture_stg.ceo_bio_2015 on gl15.country__ = ceo_culture_stg.ceo_bio_2015.Nationality
					left join ceo_culture_stg.hofstede on gl15.country__ = ceo_culture_stg.hofstede.country
					
					Union all

					select distinct gsc15.country__ as country_,  
									ceo_culture_stg.globe_leadership.Country as g_leadership_id_,
									gsc15.g_societal_culture_id_ as g_societal_culture_id_,
									ceo_culture_stg.ceo_bio_2015.id as ceo_bio_id_,
                                    ceo_culture_stg.ceo_bio_2015.`year` as year_,
									ceo_culture_stg.hofstede.hofstede_id as hofstede_id_
					from (
						select distinct `Country Name` as country__, `Country` as g_societal_culture_id_
						from ceo_culture_stg.globe_societal_culture ) gsc15
					left join ceo_culture_stg.globe_leadership on gsc15.country__ = ceo_culture_stg.globe_leadership.`Country Name`
					left join ceo_culture_stg.ceo_bio_2015 on gsc15.country__ = ceo_culture_stg.ceo_bio_2015.Nationality
					left join ceo_culture_stg.hofstede on gsc15.country__ = ceo_culture_stg.hofstede.country
					
					Union all

					SELECT distinct c15.country__ as country_,  
									ceo_culture_stg.globe_leadership.Country as g_leadership_id_,
									ceo_culture_stg.globe_societal_culture.Country as g_societal_culture_id_,
									c15.ceo_bio_id_ as ceo_bio_id_,
                                    c15.`year` as year_,
									ceo_culture_stg.hofstede.hofstede_id as hofstede_id_
					from( 
						select distinct `Nationality` as country__, `id` as ceo_bio_id_, `year`
						from ceo_culture_stg.ceo_bio_2015) c15
					left join ceo_culture_stg.globe_leadership on c15.country__ = ceo_culture_stg.globe_leadership.`Country Name`
					left join ceo_culture_stg.globe_societal_culture on c15.country__ = ceo_culture_stg.globe_societal_culture.`Country Name`
					left join ceo_culture_stg.hofstede on c15.country__ = ceo_culture_stg.hofstede.country
																
					Union all
					
					SELECT distinct h15.country__ as country_,  
									ceo_culture_stg.globe_leadership.Country as g_leadership_id_,
									ceo_culture_stg.globe_societal_culture.Country as g_societal_culture_id_,
									ceo_culture_stg.ceo_bio_2015.id as ceo_bio_id_,
                                    ceo_culture_stg.ceo_bio_2015.`year` as year_,
									h15.hofstede_id_ as hofstede_id_
									
					from(
						select distinct country as country__ , `hofstede_id` as hofstede_id_
						from ceo_culture_stg.hofstede) h15
					left join ceo_culture_stg.globe_leadership on h15.country__ = ceo_culture_stg.globe_leadership.`Country Name`
					left join ceo_culture_stg.globe_societal_culture on h15.country__ = ceo_culture_stg.globe_societal_culture.`Country Name`
					left join ceo_culture_stg.ceo_bio_2015 on h15.country__ = ceo_culture_stg.ceo_bio_2015.Nationality
					)f     
